...
function SignUp() {
  ...
  const submitHandler = (event) => {
    ...
    if(isLogin){
      url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBLiObmhILV7-mxeT4ePopP3ibfV4wP6no';
    }else {
      url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBLiObmhILV7-mxeT4ePopP3ibfV4wP6no'
    }
    fetch(url,
    {
      method: 'POST',
