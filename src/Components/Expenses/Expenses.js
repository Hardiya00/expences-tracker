...
const Expenses = () => {
  ...
  const addExpenseHandler = async(event) => {
    ...
    if(isEditing){
      try{
        const res = await fetch(`https://console.firebase.google.com/project/my-first-project-71e42/database/my-first-project-71e42-default-rtdb/data/~2F${expenseEmail}/${id}.json`, {
          method: 'PUT',
    ...
    try{
      const res = await fetch(`https://console.firebase.google.com/project/my-first-project-71e42/database/my-first-project-71e42-default-rtdb/data/~2F${expenseEmail}.json`,{
        method: 'POST',
        body: JSON.stringify(obj),
        headers: {
  ...
  useEffect(() => {
    ...
    try {
      const res = await fetch(
        `https://console.firebase.google.com/project/my-first-project-71e42/database/my-first-project-71e42-default-rtdb/data/~2F${expenseEmail}.json`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
