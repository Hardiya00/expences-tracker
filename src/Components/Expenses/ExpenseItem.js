...
const ExpenseItem = (props) => {
    ...
    const deleteHandler = async (event) => {
        ...
        try {
            ...
            const res = await fetch(`https://console.firebase.google.com/project/my-first-project-71e42/database/my-first-project-71e42-default-rtdb/data/~2F/${expenseEmail}/${props.item.id}.json`,
                {
                    method: 'DELETE',
                    headers: {
